...
const Sidebar = () => {
    return(
        <div className='w-1/5 h-screen overflow-hidden relative'>
            <div className='fixed top-0 left-0 bg-white border-r-[1px] h-full w-1/5'>
                <h2 className='text-center py-[3rem] instagram text-[1.5rem]'>Instagram</h2>

                <ul className='flex flex-col gap-[1rem] justify-center items-start px-3'>
                    <li className=' w-full rounded-md py-2 px-2'>
