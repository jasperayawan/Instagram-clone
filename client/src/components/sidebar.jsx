...
const Sidebar = () => {
    return(
        <div className='bottom-0 left-0 fixed md:relative w-full h-[70px] md:w-[70px] lg:w-1/5 md:h-screen overflow-hidden z-50'>
            <div className='hidden md:block bottom-0 left-0 bg-white w-full sm:border-t-[1px] fixed md:top-0 md:left-0  md:border-r-[1px] md:h-full md:w-[70px] lg:w-1/5'>
                ...
                <ul className='flex md:flex-col gap-[1rem] justify-center items-center lg:items-start px-3'>
                    <li className='md:w-full rounded-md py-2 px-2'>
                        <Link className='flex justify-center lg:justify-start items-center gap-2'>
                    ...
                    <li className='md:w-full rounded-md py-2 px-2'>
                        <Link className='flex justify-center lg:justify-start items-center gap-2'>
                            <svg className='' xmlns="http://www.w3.org/2000/svg"  width={20} height={20} class="ionicon" viewBox="0 0 512 512"><path d="M352.92 80C288 80 256 144 256 144s-32-64-96.92-64c-52.76 0-94.54 44.14-95.08 96.81-1.1 109.33 86.73 187.08 183 252.42a16 16 0 0018 0c96.26-65.34 184.09-143.09 183-252.42-.54-52.67-42.32-96.81-95.08-96.81z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/></svg>
            ...
            <div className=' top-0 left-0 bg-white w-full border-b-[1px] fixed md:hidden'>
                <ul className='flex md:flex-col gap-1 md:gap-[1rem] justify-center items-center lg:items-start'>
                    <li className='md:w-full rounded-md py-2 px-2'>
                        <Link className='flex justify-center lg:justify-start items-center gap-2'>
                            <h2 className='text-center instagram text-[1.5rem]'>
                                <span className='md:hidden '>Instagram</span>
                            </h2>
                        </Link>
                    </li>
                    <li className='md:w-full rounded-md py-2 px-1'>
                        <Link className='flex justify-center lg:justify-start items-center gap-2 rounded-md relative'>
                            <input type="search" className='outline-none bg-gray-100 w-full rounded-md py-1 pl-10' placeholder='search'/>
                            <svg className='absolute top-[6px] left-3 text-gray-400' xmlns="http://www.w3.org/2000/svg" width={20} height={20} class="ionicon" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"/></svg>
                        </Link>
                    </li>
            ...
            <div className=' bottom-0 left-0 bg-white w-full border-t-[1px] fixed md:hidden'>
                <h2 className='hidden md:flex text-center md:justify-center px-3 md:items-center py-[3rem] instagram text-[1.5rem]'>
                    <svg className=' lg:hidden' xmlns="http://www.w3.org/2000/svg" width={20} height={20} class="ionicon" viewBox="0 0 512 512"><path d="M349.33 69.33a93.62 93.62 0 0193.34 93.34v186.66a93.62 93.62 0 01-93.34 93.34H162.67a93.62 93.62 0 01-93.34-93.34V162.67a93.62 93.62 0 0193.34-93.34h186.66m0-37.33H162.67C90.8 32 32 90.8 32 162.67v186.66C32 421.2 90.8 480 162.67 480h186.66C421.2 480 480 421.2 480 349.33V162.67C480 90.8 421.2 32 349.33 32z"/><path d="M377.33 162.67a28 28 0 1128-28 27.94 27.94 0 01-28 28zM256 181.33A74.67 74.67 0 11181.33 256 74.75 74.75 0 01256 181.33m0-37.33a112 112 0 10112 112 112 112 0 00-112-112z"/></svg>
                    <span className='hidden lg:flex'>Instagram</span>
                </h2>
